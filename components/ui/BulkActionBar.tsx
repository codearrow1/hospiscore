  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onClear}
        className="ml-auto inline-flex min-h-9 items-center rounded-lg px-3 py-1.5 text-xs font-semibold text-indigo-600 hover:bg-indigo-100 dark:text-indigo-300 dark:hover:bg-indigo-900"
      >
        Clear selection
      </button>
    </div>
