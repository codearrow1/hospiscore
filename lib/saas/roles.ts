...
const ROLE_SAAS_PERMS: Record<string, ReadonlySet<SaasPermission>> = {
  super_admin: new Set([
    ...
    "PARTNER_VIEW","PARTNER_MANAGE","FRANCHISE_VIEW","FRANCHISE_MANAGE","FRANCHISE_FINANCE","FEATURE_FLAG_MANAGE","SUPPORT_VIEW","SUPPORT_MANAGE","AUDIT_VIEW","SYSTEM_SETTINGS_MANAGE",
  ]),
