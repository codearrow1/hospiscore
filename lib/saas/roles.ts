...
const ROLE_SAAS_PERMS: Record<string, ReadonlySet<SaasPermission>> = {
  super_admin: new Set([
    ...
    "PARTNER_VIEW","PARTNER_MANAGE","FRANCHISE_VIEW","FRANCHISE_MANAGE","FRANCHISE_FINANCE","FEATURE_FLAG_MANAGE","AUDIT_VIEW","SYSTEM_SETTINGS_MANAGE",
  ]),
  ...
  marketing_admin: new Set([
    "CUSTOMER_VIEW","CUSTOMER_MANAGE","PROPERTY_VIEW","PROPERTY_MANAGE","PLAN_VIEW","PLAN_MANAGE",
    "SUBSCRIPTION_VIEW","SUBSCRIPTION_MANAGE","BILLING_VIEW","BILLING_MANAGE","USAGE_VIEW","MARKETING_VIEW","MARKETING_MANAGE","AUDIT_VIEW",
  ]),
  sales_admin: new Set(["CUSTOMER_VIEW","CUSTOMER_MANAGE","PROPERTY_VIEW","PROPERTY_MANAGE","SUBSCRIPTION_VIEW","SUBSCRIPTION_MANAGE","USAGE_VIEW","AUDIT_VIEW"]),
  customer_success: new Set(["CUSTOMER_VIEW","CUSTOMER_MANAGE","PROPERTY_VIEW","SUBSCRIPTION_VIEW","USAGE_VIEW","BILLING_VIEW","AUDIT_VIEW"]),
  support_admin: new Set(["CUSTOMER_VIEW","SUBSCRIPTION_VIEW","BILLING_VIEW","PROPERTY_VIEW","AUDIT_VIEW","USAGE_VIEW"]),
  ...
  read_only: new Set(["CUSTOMER_VIEW","PROPERTY_VIEW","PLAN_VIEW","SUBSCRIPTION_VIEW","BILLING_VIEW","USAGE_VIEW","MARKETING_VIEW","AFFILIATE_VIEW","PARTNER_VIEW","FRANCHISE_VIEW","AUDIT_VIEW"]),
  marketing_manager: new Set(["CUSTOMER_VIEW","PROPERTY_VIEW","PLAN_VIEW","SUBSCRIPTION_VIEW","BILLING_VIEW","MARKETING_VIEW"]),
  sales_manager: new Set(["CUSTOMER_VIEW","CUSTOMER_MANAGE","PROPERTY_VIEW","SUBSCRIPTION_VIEW","USAGE_VIEW"]),
